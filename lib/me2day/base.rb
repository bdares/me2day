...
module Me2day
  class Base
    ...
    # return [Me2day::IdentityMap]
    def self.identity_map
      return unless Me2day.identity_map
      @identity_map = Me2day.identity_map.new unless defined?(@identity_map) && @identity_map.class == Me2day.identity_map
      @identity_map
    end
